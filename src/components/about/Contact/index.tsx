...
export default function Contact() {
  return (
    <section className="lg:px-15 flex min-h-screen flex-col items-center justify-center gap-20 bg-white px-5 py-10 uppercase text-background md:px-1 md:py-20">
      <div className="md:w-3/4">
        <p className="text-medium my-2 flex flex-col font-sans text-4xl font-semibold uppercase text-background md:my-12 md:text-8xl lg:text-7xl  xl:text-9xl">
          <motion.span className="text-left">Connect</motion.span>
          <span className="text-right">with us ✦ </span>
        </p>
              ...
              {socialMediaLinks.map((link, i) => {
                ...
                return (
                  <motion.button
                    ...
                    initial="initial"
                  >
                    <SocialMediaButton color="background" href={href} id={id} size={25} />
                  </motion.button>
                );
              })}
            </div>
